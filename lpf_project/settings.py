"""
Django settings for lpf_project project.
...
SECRET_KEY = 'django-insecure-9u4(c%8#dz7ps!o%l+$j-#yhvdqx#7r3+jt)c)trmmfjw%gq%d'
...
WSGI_APPLICATION = 'lpf_project.wsgi.application'
